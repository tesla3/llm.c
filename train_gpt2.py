...
import torch._inductor.config as t_config
from torch.nn.parallel import DistributedDataParallel as DDP
from torch.distributed import init_process_group, destroy_process_group
import torch.distributed as dist

from models.gpt import GPT, GPTConfig
from utils.python_c import write_tokenizer, write_state, write_model
...
if __name__ == "__main__":
    ...
    if args.model[0] == "d":
        ...
        model_config = {
            "d12": GPTConfig(block_size=1024, vocab_size=50257, n_layer=12, n_head=12, n_embd=768, flash=args.flash),
            "d24": GPTConfig(block_size=1024, vocab_size=50257, n_layer=24, n_head=16, n_embd=1024, flash=args.flash),
            "d36": GPTConfig(block_size=1024, vocab_size=50257, n_layer=36, n_head=20, n_embd=1280, flash=args.flash),
            "d48": GPTConfig(block_size=1024, vocab_size=50257, n_layer=48, n_head=25, n_embd=1600, flash=args.flash),
        }[args.model]
    ...
    model.to(device)
    if args.compile:
        if hasattr(t_config, "coordinate_descent_tuning"):
            t_config.coordinate_descent_tuning = True # suggested by @Chillee
